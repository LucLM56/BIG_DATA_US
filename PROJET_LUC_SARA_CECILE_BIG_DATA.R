...
#Graphiques
plot(base2$INDPRO, type="l", main="Production industrielle") #Production industrielle
plot(base2$UNRATE, type="l", main="Taux de chomage") #Taux de chomage
plot(base2$CE16OV, type="l", main="Taux d'emploi") #Taux de d'emploi
plot(base2$CPIAUCSL, type="l", main = "Inflation") #Inflation
plot(base2$HOUST, type="l", main="Construction") #Construction
